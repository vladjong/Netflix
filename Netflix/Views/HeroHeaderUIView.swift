...
class HeroHeaderUIView: UIView {
    ...
    private let heroImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "spider_man")
        return imageView
    }()
    ...
    override init(frame: CGRect) {
        ...
        applyConstraintPlayButton()
        addSubview(downloadButton)
        applyConstraintDownloadButton()
    }
    
    private func applyConstraintPlayButton() {
    ...
    private func applyConstraintDownloadButton() {
