...
protocol CollectionViewTableViewCellIDelegate:AnyObject {
...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    weak var delegate: CollectionViewTableViewCellIDelegate?
...
extension CollectionViewTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let model = titles[indexPath.row].image else {
            return UICollectionViewCell()
        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName + " trailer") { [weak self] result in
            ...
            case .success(let videoElement):
                ...
                let viewModel = TitlePreviewViewModel(title: titleName, youtubeView: videoElement)
